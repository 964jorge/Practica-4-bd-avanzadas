DROP FOREIGN TABLE IF EXISTS Entradas CASCADE;

DROP FOREIGN TABLE IF EXISTS Grupos_Tocan_Conciertos CASCADE;

DROP FOREIGN TABLE IF EXISTS Conciertos CASCADE;

DROP FOREIGN TABLE IF EXISTS Musicos CASCADE;
